...
HangupCauses.AST_CAUSE_BUSY = HangupCauses.AST_CAUSE_USER_BUSY;
HangupCauses.AST_CAUSE_FAILURE = HangupCauses.AST_CAUSE_NETWORK_OUT_OF_ORDER;
HangupCauses.AST_CAUSE_NORMAL = HangupCauses.AST_CAUSE_NORMAL_CLEARING;
HangupCauses.AST_CAUSE_NOANSWER = HangupCauses.AST_CAUSE_NO_ANSWER;
HangupCauses.AST_CAUSE_CONGESTION = HangupCauses.AST_CAUSE_NORMAL_CIRCUIT_CONGESTION;
HangupCauses.AST_CAUSE_UNREGISTERED = HangupCauses.AST_CAUSE_SUBSCRIBER_ABSENT;
HangupCauses.AST_CAUSE_NOTDEFINED = 0;
HangupCauses.AST_CAUSE_NOSUCHDRIVER = HangupCauses.AST_CAUSE_CHAN_NOT_IMPLEMENTED;

HangupCauses.STRANGE = 47; // in code but not known
HangupCauses.UNKNOWN = -1;

Object.freeze(HangupCauses);
